...
import (
	...
	"github.com/sgatewood/job-deployment/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "975bce4f.sgatewood.dev",
	...
	if err = (&controller.JobDeploymentReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "JobDeployment")
		os.Exit(1)
	}
